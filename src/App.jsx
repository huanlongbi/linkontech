        ...
        <div className="flex min-h-screen items-center justify-center bg-slate-50 px-6">
          <div className="max-w-lg rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Our engineers will review your request and contact you within 24 hours.
            </p>

            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
              <button
                onClick={() => navigate("/contact")}
                className="rounded-md border border-slate-300 px-5 py-2 text-sm text-slate-700 hover:bg-slate-100"
              >
                Back to Contact
              </button>
              ...
              <button
                ...
                className="rounded-md bg-blue-900 px-5 py-2 text-sm text-white hover:opacity-90"
              >
                Explore Services
              </button>
            </div>
